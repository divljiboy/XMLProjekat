...
<xsl:stylesheet version="2.0" xmlns:akt="aktovi"
			...
			<fo:page-sequence master-reference="my-page">
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block font-family="Calibri">
						<fo:block>
							<xsl:value-of select="akt:Pravni_akt/akt:Drzava" />
						</fo:block>
						<fo:block>
							<xsl:value-of select="akt:Pravni_akt/akt:Pokrajina" />
						</fo:block>
						<fo:block>
							<xsl:value-of select="akt:Pravni_akt/akt:Grad" />
						</fo:block>
						<fo:block>
							<xsl:value-of select="akt:Pravni_akt/akt:Skupstina" />
						</fo:block>
						<fo:block>
							<xsl:value-of select="akt:Pravni_akt/akt:Broj_popisa_kod_organa" />
						</fo:block>
						<fo:block>
							<xsl:value-of select="akt:Pravni_akt/akt:Datum_donosenja_propisa" />
						</fo:block>
						<fo:block>
							<xsl:value-of select="akt:Pravni_akt/akt:Mesto_donosenja_propisa" />
						</fo:block>
						<fo:block>
							<xsl:value-of select="akt:Pravni_akt/akt:Ovlasceno_lice/akt:Titula" />
						</fo:block>
						<fo:block>
							<xsl:value-of select="akt:Pravni_akt/akt:Ovlasceno_lice/akt:Ime" />
						</fo:block>
						<fo:block>
							<xsl:value-of select="akt:Pravni_akt/akt:Ovlasceno_lice/akt:Prezime" />
						</fo:block>
